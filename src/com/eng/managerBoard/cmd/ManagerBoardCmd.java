package com.eng.managerBoard.cmd;
...
public class ManagerBoardCmd {
	private HttpServletRequest request = null;
	private HttpServletResponse response = null;
	private Tray reqTray = null;
	
	public ManagerBoardCmd(){
	}
	
	public ManagerBoardCmd(Tray reqTray, HttpServletRequest request, HttpServletResponse response) {
