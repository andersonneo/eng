package com.dhitech.framework.crypto;
 ...
 * KISA���� f���ϴ� ��.��ȣȭ ���
 *
 * KISA���� �����ϴ� SEED(128bits �? ��ȣ �˰?��)�� wrapping�� Ŭ�����̴�.
 *
 * ��ó : http://www.kisa.or.kr/kisa/seed/jsp/seed.jsp
 * </pre>
 * @author Xagent
 *
 */
...
public class TBSeed
{
        ...
        /**
         * <pre>
         * ����Ʈ �迭; Ű�� ��ȣȭ�ؼ� outData�� �����Ѵ�.
         *
         * </pre>
         * @param pbData ��ȣȭ�� ����Ʈ �迭
         * @param pdwRoundKey ��ȣ Ű
         * @param outData ��� ������ 16 bytes ����
         */
        ...
        /**
         * <pre>
         * ��ȣȭ�� ����Ʈ�迭; Ű�� ��ȣȭ�ؼ� outData�� ��� �����Ѵ�.
         * <pre>
         * @param pbData ��ȣȭ�� ����Ʈ �迭
         * @param pdwRoundKey ��ȣ Ű
         * @param outData ��ȣȭ�� ����Ʈ �迭
         */
