package com.dhitech.framework.ep;
import java.io.*;
...
public class EpTrayUtil {
	public static String DecryptDataList(String pubkey,String seckey, String encdata){
		try{
			...
			byte[] baNewDataList = com.dhitech.framework.ep.Utils.base64Decode(encdata.getBytes("US-ASCII"));
			byte[] baMD5SecureKey = com.dhitech.framework.ep.Utils.base64Decode(seckey.getBytes("US-ASCII"));
			byte[] baPublicKey = com.dhitech.framework.ep.Utils.base64Decode(pubkey.getBytes("US-ASCII"));
			...
			byte[] baDecryptedSecretKey = com.dhitech.framework.ep.Utils.base64Decode(token2.nextToken().getBytes("US-ASCII"));
